import fs from 'fs';
import type { ResponseLike } from 'sambanovasdk/internal/to-file';
import { toFile } from 'sambanovasdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('sambanovasdk/core/uploads');
    await expect(
